// ***********************************************************************
//
// This File (Imports.cs) is for use with FFXINAV.dll.
//
// FFXINAV.dll is free Dynamic Link Library: you can redistribute, You must give appropriate credit.
// Non-Commercial - You may not use the material (FFXINAV.dll) for commercial purposes.
//
// FFXINAV.dll is distributed in the hope that it will be useful for creating navigation meshes and
// path-find on those meshes. This software is provided 'as-is', without any express or implied
// warranty. In no event will the author be held liable for any damages arising from the use of this software.
//
// FFXINAV.dll makes use of open source software (Recast Detour) without which FFXINAV.dll would not
// be possible. Recast Detour home page found here https://masagroup.github.io/recastdetour/
//
...
namespace Ffxi_Navmesh_Builder.Common
{
    public class Ffxinav : IDisposable
    {
        ...
        /// <returns>
        /// <c> true </c> if this instance [can see destination] the specified start; otherwise, <c>
        /// false </c> .
        /// </returns>
        ...
        /// always leave false if you are using meshes made with FFXINAV.dll or XIExporter, set true
        /// if meshes were built with obj's files from noesis <c> true </c> [use custom].
        /// </param>
        /// <returns> </returns>
        ...
        /// <returns>
        /// <c> true </c> if [is position in water] [the specified position]; otherwise, <c> false </c>.
        /// </returns>
        ...
        /// <param name="end">                 The end. </param>
        /// <returns>
        /// <c> true </c> If nothing blocks line of sight between two Way-points on the mesh;
        /// otherwise, <c> false </c>.
        /// </returns>
        ...
        /// <param name="pFfxiNavClassObject"> The p ffxinav class object. </param>
        /// <param name="path">               
        /// The path. e.g string.Format(@"{0}\\Dumped NavMeshes\\100.nav", Directory.GetCurrentDirectory())))
        /// </param>
        /// <returns> </returns>
        ...
        /// <param name="pFfxiNavClassObject"> The p ffxinav class object. </param>
        /// <param name="pointer">            
        /// A pointer to an IntPtr(pointer to a pointer) to hold vector address.
        /// </param>
        ...
        /// <param name="pFfxiNavClassObject"> The p ffxinav class object. </param>
        /// <returns>
        /// <c> true </c> if [NavMesh is enabled] [the specified p ffxinav class object]; otherwise,
        /// <c> false </c>.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// <c> true </c> if [is valid position on the NavMesh] [the specified p ffxinav class
        ...
        /// <param name="pFfxiNavClassObject"> The p ffxinav class object. </param>
        /// <param name="path">               
        /// The path to the Obj file, used when building NavMeshes.
        /// </param>
        /// <returns> </returns>
        ...
        /// <summary> Unloads & resets the mesh builder. </summary> <param
        /// name="pFfxiNavClassObject"> The p ffxinav class object. </param> <returns></returns>
